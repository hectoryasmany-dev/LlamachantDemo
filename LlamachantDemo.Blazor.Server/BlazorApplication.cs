...
using LlamachantDemo.Blazor.Server.Services;

namespace LlamachantDemo.Blazor.Server {
    public partial class LlamachantDemoBlazorApplication : BlazorApplication {
        public LlamachantDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void LlamachantDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
